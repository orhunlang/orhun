...
std::string lspTamamlamaSonucuJson() {
  ...
  static const std::vector<TamamlamaOgesi> ogeler = {
      ...
      {"token_araligi", 3, "Orhun lexer yardımcısı"},
      {"token_araliklari", 3, "Orhun lexer yardımcısı"},
      {"lexer_ir_uyumlu_mu", 3, "Orhun lexer IR yardımcısı"},
      {"lexer_ir_dogrula", 3, "Orhun lexer IR yardımcısı"},
      {"lexer_ir_gecerli_mi", 3, "Orhun lexer IR yardımcısı"},
      {"lexer_ir_ozeti", 3, "Orhun lexer IR yardımcısı"},
      {"token_uzunlugu", 3, "Orhun dil yardımcısı"},
      {"ozetle_lexer_sonucu", 3, "Orhun parser yardımcısı"},
      {"ifade_satir_araligi", 3, "Orhun parser yardımcısı"},
      {"ifade_satir_araliklari", 3, "Orhun parser yardımcısı"},
      {"tum_ifade_satir_araliklari", 3, "Orhun parser yardımcısı"},
      {"ifade_derinligi", 3, "Orhun parser yardımcısı"},
      {"tum_ifade_derinligi", 3, "Orhun parser yardımcısı"},
      {"ifade_turleri", 3, "Orhun parser yardımcısı"},
      {"ifade_sayisi", 3, "Orhun parser yardımcısı"},
      {"ifade_turu_sayisi", 3, "Orhun parser yardımcısı"},
      {"ifade_turu_var_mi", 3, "Orhun parser yardımcısı"},
      {"ifade_agaci_ozeti", 3, "Orhun parser yardımcısı"},
      {"ifade_tur_sayilari", 3, "Orhun parser yardımcısı"},
      {"ifade_turu_araliklari", 3, "Orhun parser yardımcısı"},
      {"komut_satir_araligi", 3, "Orhun parser yardımcısı"},
      {"komut_satir_araliklari", 3, "Orhun parser yardımcısı"},
      {"tum_komut_satir_araliklari", 3, "Orhun parser yardımcısı"},
      {"komut_derinligi", 3, "Orhun parser yardımcısı"},
      {"tum_komut_derinligi", 3, "Orhun parser yardımcısı"},
      {"komut_turleri", 3, "Orhun parser yardımcısı"},
      {"komut_sayisi", 3, "Orhun parser yardımcısı"},
      {"komut_turu_sayisi", 3, "Orhun parser yardımcısı"},
      {"komut_turu_var_mi", 3, "Orhun parser yardımcısı"},
      {"komut_agaci_ozeti", 3, "Orhun parser yardımcısı"},
      {"komut_tur_sayilari", 3, "Orhun parser yardımcısı"},
      {"komut_turu_araliklari", 3, "Orhun parser yardımcısı"},
      {"ir_uyumlu_mu", 3, "Orhun ara temsil yardımcısı"},
      {"ir_dogrula", 3, "Orhun ara temsil yardımcısı"},
      {"ir_gecerli_mi", 3, "Orhun ara temsil yardımcısı"},
      {"ir_ozeti", 3, "Orhun ara temsil yardımcısı"},
      {"ir_indeksi", 3, "Orhun parser yardımcısı"},
      {"hata_tanisi", 3, "Orhun parser yardımcısı"},
      {"hata_tanilari", 3, "Orhun parser yardımcısı"},
      {"tani_listesi_bicimlendir", 3, "Orhun tanı yardımcısı"},
      {"tani_listesi_kaynak_bicimlendir", 3, "Orhun tanı yardımcısı"},
      {"tani_listesi_seviyeleri", 3, "Orhun tanı yardımcısı"},
      {"tani_listesi_seviye_sayisi", 3, "Orhun tanı yardımcısı"},
      {"tani_listesi_seviyeye_gore_filtrele", 3, "Orhun tanı yardımcısı"},
      {"tani_listesi_ozeti", 3, "Orhun tanı yardımcısı"},
      {"dugumleri_duzlestir", 3, "Orhun AST yardımcısı"},
      {"dugum_turlerini_duzlestir", 3, "Orhun AST yardımcısı"},
      {"dugumleri_filtrele", 3, "Orhun AST yardımcısı"},
      {"dugum_turu_var_mi", 3, "Orhun AST yardımcısı"},
      {"dugum_derinligi", 3, "Orhun AST yardımcısı"},
      {"dugum_turu_sayisi", 3, "Orhun AST yardımcısı"},
      {"dugum_ozeti", 3, "Orhun AST yardımcısı"},
...
bool lspYerlesikImzasiCoz(const std::string &ad, std::string *etiket,
  ...
  static const std::vector<Imza> imzalar = {
      ...
      {"token_araligi", "token_araligi(token)", {"token"}},
      {"token_araliklari", "token_araliklari(tokenlar)", {"tokenlar"}},
      {"lexer_ir_uyumlu_mu", "lexer_ir_uyumlu_mu(sonuc)", {"sonuc"}},
      {"lexer_ir_dogrula", "lexer_ir_dogrula(sonuc)", {"sonuc"}},
      {"lexer_ir_gecerli_mi", "lexer_ir_gecerli_mi(sonuc)", {"sonuc"}},
      {"lexer_ir_ozeti", "lexer_ir_ozeti(sonuc)", {"sonuc"}},
      {"token_uzunlugu", "token_uzunlugu(token)", {"token"}},
      {"ozetle_lexer_sonucu", "ozetle_lexer_sonucu(lexer_sonucu)",
       {"lexer_sonucu"}},
      {"ifade_satir_araligi", "ifade_satir_araligi(ifade)", {"ifade"}},
      {"ifade_satir_araliklari", "ifade_satir_araliklari(sonuc)",
       {"sonuc"}},
      {"tum_ifade_satir_araliklari", "tum_ifade_satir_araliklari(sonuc)",
       {"sonuc"}},
      {"ifade_derinligi", "ifade_derinligi(ifade)", {"ifade"}},
      {"tum_ifade_derinligi", "tum_ifade_derinligi(sonuc)", {"sonuc"}},
      {"ifade_turleri", "ifade_turleri(sonuc)", {"sonuc"}},
      {"ifade_sayisi", "ifade_sayisi(sonuc)", {"sonuc"}},
      {"ifade_turu_sayisi", "ifade_turu_sayisi(sonuc, tur)",
       {"sonuc", "tur"}},
      {"ifade_turu_var_mi", "ifade_turu_var_mi(sonuc, tur)",
       {"sonuc", "tur"}},
      {"ifade_agaci_ozeti", "ifade_agaci_ozeti(sonuc)", {"sonuc"}},
      {"ifade_tur_sayilari", "ifade_tur_sayilari(sonuc)", {"sonuc"}},
      {"ifade_turu_araliklari", "ifade_turu_araliklari(sonuc, tur)",
       {"sonuc", "tur"}},
      {"komut_satir_araligi", "komut_satir_araligi(komut)", {"komut"}},
      {"komut_satir_araliklari", "komut_satir_araliklari(sonuc)",
       {"sonuc"}},
      {"tum_komut_satir_araliklari", "tum_komut_satir_araliklari(sonuc)",
       {"sonuc"}},
      {"komut_derinligi", "komut_derinligi(komut)", {"komut"}},
      {"tum_komut_derinligi", "tum_komut_derinligi(sonuc)", {"sonuc"}},
      {"komut_turleri", "komut_turleri(sonuc)", {"sonuc"}},
      {"komut_sayisi", "komut_sayisi(sonuc)", {"sonuc"}},
      {"komut_turu_sayisi", "komut_turu_sayisi(sonuc, tur)",
       {"sonuc", "tur"}},
      {"komut_turu_var_mi", "komut_turu_var_mi(sonuc, tur)",
       {"sonuc", "tur"}},
      {"komut_agaci_ozeti", "komut_agaci_ozeti(sonuc)", {"sonuc"}},
      {"komut_tur_sayilari", "komut_tur_sayilari(sonuc)", {"sonuc"}},
      {"komut_turu_araliklari", "komut_turu_araliklari(sonuc, tur)",
       {"sonuc", "tur"}},
      {"ir_uyumlu_mu", "ir_uyumlu_mu(sonuc)", {"sonuc"}},
      {"ir_dogrula", "ir_dogrula(sonuc)", {"sonuc"}},
      {"ir_gecerli_mi", "ir_gecerli_mi(sonuc)", {"sonuc"}},
      {"ir_ozeti", "ir_ozeti(sonuc)", {"sonuc"}},
      {"ir_indeksi", "ir_indeksi(sonuc)", {"sonuc"}},
      {"hata_tanisi", "hata_tanisi(sonuc)", {"sonuc"}},
      {"hata_tanilari", "hata_tanilari(sonuc)", {"sonuc"}},
      {"tani_listesi_bicimlendir", "tani_listesi_bicimlendir(tanilar)",
       {"tanilar"}},
      {"tani_listesi_kaynak_bicimlendir",
       "tani_listesi_kaynak_bicimlendir(tanilar, kaynak)",
       {"tanilar", "kaynak"}},
      {"tani_listesi_seviyeleri", "tani_listesi_seviyeleri(tanilar)",
       {"tanilar"}},
      {"tani_listesi_seviye_sayisi",
       "tani_listesi_seviye_sayisi(tanilar, seviye)",
       {"tanilar", "seviye"}},
      {"tani_listesi_seviyeye_gore_filtrele",
       "tani_listesi_seviyeye_gore_filtrele(tanilar, seviye)",
       {"tanilar", "seviye"}},
      {"tani_listesi_ozeti", "tani_listesi_ozeti(tanilar)",
       {"tanilar"}},
      {"dugumleri_duzlestir", "dugumleri_duzlestir(kok)", {"kok"}},
      {"dugum_turlerini_duzlestir", "dugum_turlerini_duzlestir(kok)",
       {"kok"}},
      {"dugumleri_filtrele", "dugumleri_filtrele(kok, tur)",
       {"kok", "tur"}},
      {"dugum_turu_var_mi", "dugum_turu_var_mi(kok, tur)",
       {"kok", "tur"}},
      {"dugum_derinligi", "dugum_derinligi(kok)", {"kok"}},
      {"dugum_turu_sayisi", "dugum_turu_sayisi(kok, tur)",
       {"kok", "tur"}},
      {"dugum_ozeti", "dugum_ozeti(kok)", {"kok"}},
