...
fixtures and 47 parser error fixtures. Command metadata covers declaration
...
postfix, collection, and `paralel yap` expressions, unknown command typos such as `yzdır 1`,
