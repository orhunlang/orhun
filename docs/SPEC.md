...
fixtures and 15 parser error fixtures. Command metadata covers declaration
...
missing `kez`, required header colons, malformed anonymous-function and
`paralel yap` expressions, unknown command typos such as `yzdır 1`,
