...
child parity basladi. `orhun/parser.oh` 0.3.40 atama `bildirim` ve hedef
...
postfix ozetlerini, islev cagri adlarini, yeni nesne sinif adlarini ve
arguman sayilarini C++ AST ile karsilastiriyor.
