...
child parity basladi. `orhun/parser.oh` 0.3.18 atama `bildirim` ve hedef
...
govde ifadesini, liste uretec degiskenini ve liste/sozluk literal postfix
ozetlerini C++ AST ile karsilastiriyor.
